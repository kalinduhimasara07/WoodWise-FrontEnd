    ...
    <footer className="bg-slate-800 text-white py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-white transition-colors">Mahogany</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Teak</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">TV Console</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Wardrobe</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Mirrors</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Writing Tables</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Credenzas</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-white transition-colors">Throw Pillows</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Pillow Inserts</a></li>
            </ul>
            
            <h3 className="text-lg font-semibold mb-4 mt-6">DECOR</h3>
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-white transition-colors">Natural Plants</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Artificial Plants</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Decorative Items</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Scented Candles</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Lamps</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Ceramic Pot</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Wall Frames</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-6 mb-8 text-gray-300 text-sm">
          ...
          <a href="#" className="hover:text-white transition-colors">Refund & Delivery Policy</a>
        </div>
        ...
        <div className="border-t border-slate-700 pt-6">
          <p className="text-center text-gray-400 text-sm">
            © 2025 WoodWise Capital Ventures. All Rights Reserved | Powered By KH
          </p>
        </div>
