...
const FurnitureCard = ({ furniture }) => {
  ...
  const handleCardClick = () => {
    navigate(`/admin/store/showcase/${furniture.sku}`);
  };
...
const StoreShowCase = () => {
  ...
  if (loading) {
    return (
      <div className="w-full bg-gray-50 flex items-center justify-center rounded-3xl p-6">
  ...
  if (error) {
    return (
      <div className="w-full h-full rounded-3xl p-6 bg-white flex items-center justify-center">
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
          <div>
            <button
              onClick={() => navigate("/",{ state: { from: "adminstoreShowcase" }})}
              className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors cursor-pointer absolute top-4 right-4 shadow-lg"
            >
              View Smart Showcase
            </button>
          </div>
