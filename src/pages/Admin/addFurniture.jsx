...
function AddFurniture() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/furniture/add-furniture', {
                method: 'POST',
                body: formDataToSend
            });
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-lg shadow-lg">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200">
                        <h1 className="text-2xl font-bold text-gray-900">Add New Furniture Item</h1>
                        <p className="mt-1 text-sm text-gray-600">Fill in the details below to add a new furniture item to your store</p>
                    </div>
