...
export default function PlaceOrder() {
  ...
  if (productData) {
    ...
    setOrder((prev) => ({
      ...prev,
      isCustom: true,
      customImage: productData.uploadedImageUrl,
    }));
  }
}, [productData]);
...
const addItem = () => {
  setFurnitureItems([
    ...furnitureItems,
    { sku: "", quantity: 1, unitPrice: 0, note: "", isCustom: false },
  ]);
};
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    setFurnitureItems([{ sku: "", quantity: 1, unitPrice: 0, note: "", isCustom: false }]);
    setOrder({
      totalAmount: 0,
      advanceAmount: 0,
      customerInfo: {
